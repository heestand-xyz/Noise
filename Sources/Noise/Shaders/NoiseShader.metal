...
#import "Shared/noise_header.metal"
#import "Shared/random_header.metal"
...
[[ stitchable ]] half4 noise(float2 position,
    ...
    float4 noiseColor = float4(red * tint.r * brightness,
                               green * tint.g * brightness,
                               blue * tint.b * brightness,
                               1.0);
